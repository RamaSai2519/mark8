...
class WaChatHelper:
    ...
    def get_system_message(self) -> str:
        ...
        prompt += "\n\n ONLY SHARE AND ANSWER THE QUESTIONS ABOUT THE INFORMATION YOU HAVE BEEN PROVIDED WITH. DO NOT SHARE ANY OTHER INFORMATION OR ENGAGE IN ANY OTHER CONVERSATION WITH THE USER. DO NOT ASSUME ANYTHING THAT YOU DON'T KNOW ABOUT THE COMPANY OR THE SERVICES PROVIDED BY THE COMPANY. IF YOU ARE UNSURE ABOUT ANYTHING, PLEASE DIRECT THE USER TO THE SUPPORT TEAM. \n\n"
        return prompt
