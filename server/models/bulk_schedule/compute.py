from shared.models.interfaces import BulkScheduleInput as Input, Output
...
class Compute:
    ...
    def compute(self) -> Output:
        required_columns = {'user', 'saarthi'}
        if not required_columns.issubset(self.calls_df.columns):
            return Output(
                output_message="Invalid input file. Required columns are 'user' and 'saarthi'."
            )
        ...
        return Output(
            output_message="Hojayega, phikar not"
        )
